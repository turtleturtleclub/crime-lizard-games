...
export const QUEST_FIRST_SCORE: EnhancedQuest = {
...
export const QUEST_DRESS_FOR_SUCCESS: EnhancedQuest = {
...
export const QUEST_ROBIN_HOOD_DILEMMA: EnhancedQuest = {
    id: 'quest_robin_hood_dilemma',
    title: 'The Degen Robin Hood',
    description: 'Choose your path: help the rekt degens or aid the law.',
    lore: 'The Rekt District calls. Will you be a hero to rugged lizards, or an enforcer hunting scammers? Your choice defines your legend.',
    ...
    objectives: [
        {
            ...
            type: 'talk',
            target: 'rekt_survivor_or_guard',
            amount: 1
        },
        // These are dynamically added based on choice
        {
            id: 'path_a_donate',
            description: 'Donate 200 gold to the rekt (visit The Rekt District)',
            type: 'collect',
            target: 'gold_to_rekt',
            amount: 200,
            hidden: true
        ...
        {
            id: 'path_b_bounties',
            description: 'Defeat 3 scammer players in PvP',
            type: 'kill',
...
export const QUEST_LOAN_SHARK_COLLECTION: EnhancedQuest = {
...
export const QUEST_JEWELRY_STORE_JOB: EnhancedQuest = {
...
export const QUEST_UNDERGROUND_ARENA: EnhancedQuest = {
...
export const QUEST_CORRUPTED_MAYOR: EnhancedQuest = {
...
export const QUEST_SMUGGLERS_ROUTE: EnhancedQuest = {
...
export const QUEST_DRAGONS_HOARD: EnhancedQuest = {
...
export const QUEST_BANK_HEIST: EnhancedQuest = {
    id: 'quest_bank_heist',
...
export const LEVEL_1_10_QUESTS: Record<string, EnhancedQuest> = {
    // Level 1-2
