...
export const ENEMIES: Record<string, Enemy> = {
    ...
    // ============================================
    // ECONOMY REBALANCE v3.0 - Dec 10, 2025
    // Gold Shop: 0.01 BNB (~$7) = 1,000 gold
    // Max gold per battle: 100 (server-enforced)
    // Design: 50-100 battles to afford next tier gear
    // Level 1-3: 3-15g | Level 4-6: 10-25g
    // Level 7-9: 15-35g | Level 10-14: 20-50g
    // Level 15-20: 30-60g | Level 21-30: 40-80g
    // Level 31-40: 50-100g | Bosses: 80-100g
    // ============================================
    forest_goblin: {
        id: 'forest_goblin',
    ...
    blood_demon: {
        ...
        specialAbility: {
            name: 'Life Drain',
            description: '25% chance to steal 20 HP from you',
            chance: 25
        },
    ...
    // ===========================
    // LEVEL 25-30: Champion Enemies (Challenging but fair)
    // Design: Player STR ~45, so 10-15 hits to kill = 450-700 HP
    // Enemy STR should deal ~25-40 dmg so 6-10 hits to kill player
    // ===========================
    ancient_dragon: {
        id: 'ancient_dragon',
        name: 'Ancient Dragon',
        ...
        specialAbility: {
            name: 'Ancient Fire',
            description: '35% chance to deal 1.5x damage with burning effect',
            chance: 35
        },
    ...
    demon_lord: {
        ...
        specialAbility: {
            name: 'Hellfire',
            description: '40% chance to deal fire damage and curse',
            chance: 40
        },
    ...
    celestial_warrior: {
        ...
        specialAbility: {
            name: 'Divine Smite',
            description: '35% chance to deal holy damage that ignores armor',
            chance: 35
        },
    ...
    void_harbinger: {
        ...
        specialAbility: {
            name: 'Void Tear',
            description: '40% chance to deal void damage and reduce your max HP temporarily',
            chance: 40
        },
    ...
    // ===========================
    // LEVEL 35-40: Titan Enemies (Hard endgame)
    // Player at 35: ~60 STR, ~350 HP
    // Design: 15-20 hits to kill = 900-1200 HP, enemy deals ~40-60 dmg
    // ===========================
    titan_guardian: {
        id: 'titan_guardian',
        name: 'Titan Guardian',
        ...
        specialAbility: {
            ...
            description: '40% chance to deal 1.5x damage and stun',
            chance: 40
        },
    ...
    void_creature: {
        ...
        specialAbility: {
            ...
            description: '45% chance to ignore defense and drain 25 HP',
            chance: 45
        },
    ...
    ancient_god: {
        ...
        specialAbility: {
            name: 'Divine Wrath',
            description: '50% chance to deal 2x damage',
            chance: 50
        },
    ...
    cosmic_horror: {
        ...
        specialAbility: {
            name: 'Madness',
            description: '45% chance to confuse and deal psychic damage',
            chance: 45
        },
    ...
    // ===========================
    // LEVEL 45-50: World Enders (True endgame bosses)
    // Player at 45: ~75 STR, ~450 HP
    // Design: 20-25 hits to kill = 1500-1900 HP, enemy deals ~60-80 dmg
    // ===========================
    world_ender: {
        id: 'world_ender',
        name: 'World Ender',
    ...
    primordial_being: {
        ...
        specialAbility: {
            ...
            description: '55% chance to deal 2x damage',
            chance: 55
        },
    ...
    eternal_dragon: {
        ...
        specialAbility: {
            name: 'Eternal Flame',
            description: '50% chance to deal fire damage that cannot be resisted',
            chance: 50
        },
    ...
    chaos_incarnate: {
        ...
        specialAbility: {
            name: 'Chaotic Rift',
            description: '50% chance to deal random 1.5-2x damage',
            chance: 50
        },
...
export const GAME_CONSTANTS = {
    ...
    ENEMY_SCALING_START_LEVEL: 8, // Start scaling enemies at level 8 (was 16)
    ENEMY_SCALING_MULTIPLIER: 0.12, // 12% increase per level above enemy base level (was 15%)
...
export function scaleEnemyToPlayerLevel(enemy: Enemy, playerLevel: number): Enemy {
    ...
    // Scale rewards (cap gold at 500 to maintain economy balance)
    // Economy v3.0: Max 100 gold per combat
    const MAX_GOLD_CAP = 100;
    scaledEnemy.goldMin = Math.min(Math.floor(enemy.goldMin * scalingFactor), MAX_GOLD_CAP);
    scaledEnemy.goldMax = Math.min(Math.floor(enemy.goldMax * scalingFactor), MAX_GOLD_CAP);
